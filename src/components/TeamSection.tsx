...
const TeamSection: React.FC = () => {
  ...
  return (
    <section className="bg-black bg-opacity-90 bg-[url('/images/noise-pattern.png')] bg-blend-overlay backdrop-filter backdrop-blur-md text-white py-16 overflow-hidden">
